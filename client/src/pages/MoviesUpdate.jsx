...
class MoviesUpdate extends Component {
    ...
    handleUpdateMovie = async () => {
        ...
        const id_r = id.params.id
        const arrayTime = time.split('/')
        const payload = { name, rating, time: arrayTime }

        await api.updateMovieById(id_r, payload).then(res => {
    ...
    componentDidMount = async () => {
        const { id } = this.state
        const movie = await api.getMovieById(id.params.id)
...
export default withParams(MoviesUpdate);